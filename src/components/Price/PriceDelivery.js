...
const PriceDelivery = () => {
    ...
    const priceListItem = priceListData.map( ( i, index ) => (
        <li key={index} className='price-delivery-list-item'> { i } </li>
    ))
    ...
    return (
        <div className='price-delivery'>
            ...
            <h2 className='price-delivery-title'> 
                Доставка автомобилей осуществляется транспортной компанией. 
                Мы можем порекомендовать Вам компании, о которых у нас сложилось хорошее впечатление. <br/>
            ...
            <div className='price-delivery-cost'>
                ...
                <ul className='price-delivery-list'> 
                    { priceListItem }
                </ul>
                ...
                <div className='price-where-to-find'>
                    ...
                    <ul className='price-where-to-find-list'>
                        { priceSocialItem }
                    </ul>
                </div>
            </div>
