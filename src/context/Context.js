...
const secondSliderData = [
  {
    ...
    descr:
      "Наш офис находится возле Кёльна, что позволяет полностью контролировать все этапы сделки: начиная с осмотра авто, заканчивая оформлением документов и передачей транспортного средства новому владельцу.",
  },
  {
    className: "second",
    icon: faHandshake,
    ...
    descr:
      "Этим делом мы начали заниматься еще с 2015 года. За столь продолжительное время успели досконально разобраться во всех тонкостях покупки авто в Германии, имеем большой опыт проведения действительно «чистых» сделок.",
  },
  {
    className: "third",
    icon: faFlag,
    title: "Отчетность.",
    descr:
      "Благодаря фото и видео фиксации каждый клиент получает полный отчет проделанной работы, поэтому ему нет необходимости лететь в страну для выбора подходящей модели.",
  },
  {
    className: "fourth",
    icon: faGlobe,
    title: "Мобильность.",
    descr:
      "Машины из Германии для вас будут подобраны в максимально короткое время в полном соответствии выдвинутым ранее требованиям.",
  },
  {
    className: "fifth",
    icon: faPhoneVolume,
    ...
    descr:
      "Вы будете в курсе предпринятых нами шагов. Оповещение клиента производится посредством телефонных звонков, электронной почты.",
  },
];
...
const mainHowToBuyData = [
  {
    ...
    descr:
      "Для того, чтобы заказать осмотр автомобиля в нашей компании, найдите нужный автомобиль или запчасти на сайтах поиска и свяжитесь с нами на странице заказа. В связи с большим количеством запросов,поиском автомобиля или запчастей лучше всего Вам заняться самостоятельно.",
  ...
  },
  {
    ...
    descr:
      "После обработки заявки мы согласовываем все детали по автомобилю. Далее мы выезжаем на осмотр согласованного с Вами авто.Вы получаете полный видео- и фотоотчет с осмотра, а также нашу рекомендацию, стоит покупать данный автомобиль или нет.",
  ...
  },
  {
    ...
    descr:
      "После успешного осмотра мы помогаем Вам совершить покупку автомобиля в Германии,  а также оформляем все необходимые документы, номера и страховку. Не переживайте, какие документы Вам будут нужны на таможне, потому что мы их подготовим, а также проконсультируем Вас по любым Вашим вопросам.",
    button: "Контакты",
    link: "/contacts",
  },
];
...
const signsData = [
  {
    ...
    title: "Результаты",
    descr:
      "В автомобильной сфере мы работаем с 2007 года. За это время мы накопили огромный опыт проведения чистых сделок от А до Я.",
  },
  {
    icon: faRoad,
    title: "Мобильность",
    descr:
      "В кратчайшие сроки мы осматриваем найденный Вами авто на сайтах поиска и предоставляем подробную информацию по нему.",
  },
  {
    icon: faVideo,
    title: "Отчетность",
    descr:
      "Предоставляем Фото-Видеоотчет с места осмотра в режиме онлайн. Вы присутствуете на осмотре в реальном времени.",
  },
  {
    icon: faMessage,
    title: "Всегда на связи",
    descr:
      "На протяжении всей сделки мы держим Вас в курсе всех событий как по телефону так и электронными сообщениями.",
  },
];
...
const aboutSliderData = [
  {
    ...
    descr:
      "Внимание и честность. Я всегда на стороне покупателя и готов бороться до конца, пока не найду хороший автомобиль для наших заказчиков.",
  },
  {
    src: aboutSliderPic2,
...
const pickUpData = [
  {
    ...
    descr:
      "Технический осмотр. Проверка лакокрасочного покрытия. Проверка электронных блоков управления на ошибки. Проверка пробега автомобиля. Тест драйв.",
  },
  {
  ...
  },
  {
    ...
    descr:
      "Фиксированная плата за дорогу к месту осмотра (считается только в одну сторону) — 1.8 евро/км.",
  },
];
