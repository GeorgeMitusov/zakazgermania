...
const PricePickUp = () => {
    ...
    const pricePickUpItem = pickUpData.map( ( i, id ) => (
        <motion.div 
            key={id} 
            className='pick-up-item'
            variants={pricePickUpVars}
        >
  ...
  return (
    <div className='price-pick-up'>
        <h1 className='price-pick-up-title'> Профессиональный подбор и оценка автомобиля в Германии. </h1>
        ...
        <h1 className='price-check-title'> Для расчета расстояния пользуйтесь ГУГЛ картами. Наш индекс 50354 Hürth. </h1>
